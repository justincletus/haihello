<div id="page">
            ...
            <div class="grid_2">
                ...
                <div id="header-top-inside-left-feed">
                    ...
                    <ul>									
                        ...
                        <li><a class="facebook" href="http://www.facebook.com/pages/Mega-Chips-Technology/810605208992702" title="Join Us on Facebook!"></a></li>
        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                ...
                <div id="home-blocks-area" class="clearfix">
                	<h3 style="color:green" align="center">Welcome to Megachips Technology.</h3><br>
			<p>We are aim to delivering the HIGHEST QUALITY of web development 
			and designing services to businesses across all industries.
			We are committed to the idea of creating websites that are functionall
			y solid, aesthetically beautiful and completely optimized.Customer sati				sfaction has been a primary objective in all our ventures.</p>	
            		<?php if ($messages): ?>
                    <div class="clearfix">
                    <?php print $messages; ?>
                    </div>
    ...
    <div id="footer-bottom">
        ...
        <div id="footer-bottom-inside" class="clearfix container_12">
            ...
            <div class="grid_12">
        	   <div class="credits-container" style="clear:both; padding-top:12px;">All Copy Rights@2015  <a href="http://www.megachipstechnology.in"> Mega Chips Technology.</a> </div>     
            </div>
